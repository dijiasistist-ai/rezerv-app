const categoryDefinitions = [
  ...
  { id: "bayan-kuafor", label: "Bayan Kuaför", featuredLabel: "Bayan Kuaför", icon: "💇‍♀️", cityFocus: "istanbul" },
  { id: "erkek-berber", label: "Erkek Berber", featuredLabel: "Erkek Berber", icon: "💈", cityFocus: "istanbul" },
...
const listings = [
  ...
  },
  {
    ...
    price: 750,
    priceUnit: "den başlayan fiyatlar",
    summary: "Kadın kesim, fön ve boya randevuları tek takvimde",
    ...
    responseMinutes: 3,
    boost: false,
    serviceTypes: ["bayan kuafor", "kadin kuafor", "kesim", "fon", "boya", "ombre"],
  },
  {
  ...
  },
  {
    ...
    responseMinutes: 12,
    boost: false,
    serviceTypes: ["bayan kuafor", "kadin kuafor", "gelin saci", "sac bakimi", "fon"],
  },
  {
    id: "barber-republic",
    ...
    price: 550,
    priceUnit: "hizmet",
    summary: "Saç kesim, sakal tasarım ve erkek bakım randevuları",
    tags: ["Bugün müsait", "Sakal tasarım", "Hızlı randevu"],
    cta: "Rezerv et",
    mediaClass: "media-barber",
    featured: true,
    eveningTime: "18:00",
    availability: { today: true, nextSlot: "18:00", openSlots: 4 },
    profileScore: 86,
    conversionScore: 82,
    responseMinutes: 7,
    boost: false,
    serviceTypes: ["erkek berber", "berber", "barber", "sakal", "sac kesim"],
  },
  {
    id: "marina-ocakbasi",
...
const hotSlots = [
  ...
  { time: "20:00", title: "Bayan Kuaför", venue: "Luna Hair Lounge", mediaClass: "media-hair" },
